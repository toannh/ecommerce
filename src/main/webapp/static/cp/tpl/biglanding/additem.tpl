    ...
    <div class="row">
        <div class="form-group">
            <div class="col-xs-5">
                ...
                <input name="bigLandingCateId" type="hidden" class="form-control" value="<%=bigLandingCateId%>">
            </div>
            <div class="col-xs-2">
                <button type="button" class="btn btn-primary" onclick="biglanding.saveItem('<%= bigLandingCateId %>')" >
            ...
            <tbody class="body" >
                ...
                <tr for="<%= this.id%>" class="<%= this.id%>">
                    ...
                    <td class="text-center" style="vertical-align: middle">
                        <button type="button" class="btn btn-danger bigLandingName" onclick="biglanding.delbiglandingitem('<%= this.id %>');"  ><i class="glyphicon glyphicon-trash"></i> Xóa</button>
                    </td>
                </tr>
                <% }); } %>
            </tbody>
