<form id="image-form-i" style="display:none">
    ...
    <input type="text" style="display:none" name="targetId" value="<%=(typeof data!=='undefined')? data.id: ''%>">
</form>
<form id="image-form" class="form-horizontal" role="form">
    <div class="form-group">
        ...
        <div class="col-md-5">
            <button type="button" class="btn btn-default" style="text-transform : none" onclick="biglanding.downloadImageItem();">Lấy ảnh về</button>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-5">
            <input name="itemId" value="<%=(typeof data!=='undefined')? data.itemId: ''%>" disabled="disabled" type="text" class="form-control" placeholder="Điền Id sản phẩm tại đây">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-5">
            <input name="title" value="<%=(typeof data!=='undefined')? data.name: ''%>" onchange="biglanding.changeBLItemName(this);" for="<%=(typeof data!=='undefined')? data.id: ''%>" type="text" class="form-control bigLandingName<%=(typeof data!=='undefined')? data.id: ''%>" placeholder="Tiêu đề sản phẩm">
        </div>
    </div>
</form>
