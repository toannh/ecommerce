...
<div class="lb-box lb-box2">
                    <form id="image-form-banner" style="display:none">
                    	...
                    	<div class="lb-category lb-category-right lb-bg-yellow">
                        	<div class="lbc-inner">
                        ...
                        <div class="lb-item lb-position1" onclick="biglanding.addItemNB('<%=data.id%>',1,2);">
                        ...
                        <div class="lb-item lb-bigitem lb-position2" onclick="biglanding.addItemNB('<%=data.id%>',2,2);">
                        	<div class="lbi-inner cdt-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Khuyến mại thêm 1 chuột dây mitsumi">
                        ...
                        <div class="lb-item lb-position3" onclick="biglanding.addItemNB('<%=data.id%>',3,2);">
                        	<div class="lbi-inner cdt-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Khuyến mại thêm 1 chuột dây mitsumi">
                        ...
                        <div class="lb-item lb-position4" onclick="biglanding.addItemNB('<%=data.id%>',4,2);">
                        	<div class="lbi-inner cdt-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Khuyến mại thêm 1 chuột dây mitsumi">
                        ...
                        <div class="lb-item lb-position5" onclick="biglanding.addItemNB('<%=data.id%>',5,2);">
                        	<div class="lbi-inner cdt-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Khuyến mại thêm 1 chuột dây mitsumi">
                        ...
                        <div class="lb-item lb-position6" onclick="biglanding.addItemNB('<%=data.id%>',6,2);">
                        	<div class="lbi-inner cdt-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Khuyến mại thêm 1 chuột dây mitsumi">
                        ...
                        <div class="lb-item lb-position7" onclick="biglanding.addItemNB('<%=data.id%>',7,2);">
                        	<div class="lbi-inner cdt-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Khuyến mại thêm 1 chuột dây mitsumi">
                        ...
                        <div class="lb-item lb-position8" onclick="biglanding.addItemNB('<%=data.id%>',8,2);">
                        	<div class="lbi-inner cdt-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Khuyến mại thêm 1 chuột dây mitsumi">
                        ...
                        <div class="lb-item lb-position9" onclick="biglanding.addItemNB('<%=data.id%>',9,2);">
                        	<div class="lbi-inner cdt-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Khuyến mại thêm 1 chuột dây mitsumi">
