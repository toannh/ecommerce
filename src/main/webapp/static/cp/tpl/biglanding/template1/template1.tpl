...
<div class="bg-white"><div class="fd-space"></div>
    <div class="fd-title">
        <a class="fdt-name fdt-blue" href="#"><%=(typeof data!=='undefined')? data.name: ''%></a>
    ...
    <div class="fd-box">
        ...
        <div class="fd-listitem">
            <div class="fd-item" onclick="biglanding.addItemNB('<%=data.id%>',1,1,'LT1');">
                <div class="fdi-thumb">
             ...
             <div class="fd-item" onclick="biglanding.addItemNB('<%=data.id%>',2,1,'LT1');">
                <div class="fdi-thumb">
             ...
             <div class="fd-item" onclick="biglanding.addItemNB('<%=data.id%>',3,1,'LT1');">
                <div class="fdi-thumb">
            ...
            <div class="fd-item" onclick="biglanding.addItemNB('<%=data.id%>',4,1,'LT1');">
                <div class="fdi-thumb">
            ...
            <div class="fd-item" onclick="biglanding.addItemNB('<%=data.id%>',5,1,'LT1');">
                <div class="fdi-thumb">
            ...
            <div class="fd-item" onclick="biglanding.addItemNB('<%=data.id%>',6,1,'LT1');">
                <div class="fdi-thumb">
            ...
            <div class="fd-item" onclick="biglanding.addItemNB('<%=data.id%>',7,1,'LT1');">
                <div class="fdi-thumb">
            ...
            <div class="fd-item" onclick="biglanding.addItemNB('<%=data.id%>',8,1,'LT1');">
                <div class="fdi-thumb">
