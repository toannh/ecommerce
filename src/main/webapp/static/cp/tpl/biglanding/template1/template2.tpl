...
<div class="bg-white"><div class="fd-space"></div>
    <div class="fd-title">
        <a class="fdt-name fdt-yellow" href="#"><%=(typeof data!=='undefined')? data.name: ''%></a>
    ...
    <div class="fd-box">
        ...
        <div class="fd-listitem">
            <div class="fd-item" onclick="biglanding.addItemNB('<%=data.id%>',1,2,'LT1');">
                <div class="fdi-thumb">
             ...
             <div class="fd-item" onclick="biglanding.addItemNB('<%=data.id%>',2,2,'LT1');">
                <div class="fdi-thumb">
             ...
             <div class="fd-item" onclick="biglanding.addItemNB('<%=data.id%>',3,2,'LT1');">
                <div class="fdi-thumb">
            ...
            <div class="fd-item" onclick="biglanding.addItemNB('<%=data.id%>',4,2,'LT1');">
                <div class="fdi-thumb">
            ...
            <div class="fd-item" onclick="biglanding.addItemNB('<%=data.id%>',5,2,'LT1');">
                <div class="fdi-thumb">
            ...
            <div class="fd-item" onclick="biglanding.addItemNB('<%=data.id%>',6,2,'LT1');">
                <div class="fdi-thumb">
           ...
           <div class="fd-item" onclick="biglanding.addItemNB('<%=data.id%>',7,2,'LT1');">
                <div class="fdi-thumb">
            ...
            <div class="fd-item" onclick="biglanding.addItemNB('<%=data.id%>',8,2,'LT1');">
                <div class="fdi-thumb">
