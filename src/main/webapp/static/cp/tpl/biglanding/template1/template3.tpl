...
<div class="bg-white"><div class="fd-space"></div>
    <div class="fd-title">
        <a class="fdt-name fdt-red" href="#"><%=(typeof data!=='undefined')? data.name: ''%></a>
    ...
    <div class="fd-box">
        ...
        <div class="fd-listitem">
            <div class="fd-item" onclick="biglanding.addItemNB('<%=data.id%>',1,3,'LT1');">
                <div class="fdi-thumb">
             ...
             <div class="fd-item" onclick="biglanding.addItemNB('<%=data.id%>',2,3,'LT1');">
                <div class="fdi-thumb">
             ...
             <div class="fd-item" onclick="biglanding.addItemNB('<%=data.id%>',3,3,'LT1');">
                <div class="fdi-thumb">
            ...
            <div class="fd-item" onclick="biglanding.addItemNB('<%=data.id%>',4,3,'LT1');">
                <div class="fdi-thumb">
            ...
            <div class="fd-item" onclick="biglanding.addItemNB('<%=data.id%>',5,3,'LT1');">
                <div class="fdi-thumb">
            ...
            <div class="fd-item" onclick="biglanding.addItemNB('<%=data.id%>',6,3,'LT1');">
                <div class="fdi-thumb">
           ...
           <div class="fd-item" onclick="biglanding.addItemNB('<%=data.id%>',7,3,'LT1');">
                <div class="fdi-thumb">
            ...
            <div class="fd-item" onclick="biglanding.addItemNB('<%=data.id%>',8,3,'LT1');">
                <div class="fdi-thumb">
