...
<div class="lb-box lb-box1">
                    ...
                    <div class="lb-item lb-bigitem lb-position1" onclick="biglanding.addItemNB('<%=data.id%>',1,1);">
                        <div class="lbi-inner">
                    ...
                    <div class="lb-item lb-position2" onclick="biglanding.addItemNB('<%=data.id%>',2,1);">
                    ...
                    <div class="lb-item lb-position3" onclick="biglanding.addItemNB('<%=data.id%>',3,1);">
                        <div class="lbi-inner">
                    ...
                    <div class="lb-item lb-bigitem lb-position4" onclick="biglanding.addItemNB('<%=data.id%>',4,1);">
                        <div class="lbi-inner cdt-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Khuyến mại thêm 1 chuột dây mitsumi">
                    ...
                    <div class="lb-item lb-position5" onclick="biglanding.addItemNB('<%=data.id%>',5,1);">
                        <div class="lbi-inner">
                    ...
                    <div class="lb-item lb-position6" onclick="biglanding.addItemNB('<%=data.id%>',6,1);">
                        <div class="lbi-inner cdt-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Khuyến mại thêm 1 chuột dây mitsumi">
