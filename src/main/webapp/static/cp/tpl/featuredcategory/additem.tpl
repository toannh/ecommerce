    ...
    <div class="row">
        <div class="col-xs-14 col-md-9">
            <a class="thumbnail" style="min-height: 200px">
                ...
                if(positionS == 1 || positionS == 2 || positionS == 3 || positionS == 4 || positionS == 5 || positionS == 6 || positionS == 7 || positionS == 8){
                var fag = true;
        ...
        <div class="col-xs-8 col-md-3">
            <label class="control-label col-xs-9" style="text-align: left">x1 <input type="text" id="x1" class="form-control" disabled="true" name="x" value="0"></label>
            <label class="control-label col-xs-9" style="text-align: left">y1<input type="text" id="y1" class="form-control" disabled="true" name="y" value="0"></label>
            <label class="control-label col-xs-9" style="text-align: left">Width<input type="text" id="w" class="form-control" disabled="true" name="width" value="0"></label>
            <label class="control-label col-xs-9" style="text-align: left">Height<input type="text" id="h" class="form-control" disabled="true" name="height" value="0"></label>
        </div>
...
<div class="form-group">
    ...
    <div class="col-sm-5">
        <input name="itemId" value="<%if(fag==true){%><%=itemId%><% } %>" type="text" class="form-control" placeholder="Điền Id sản phẩm tại đây" onblur="featuredcategory.get(this.value);" />
...
<div class="form-group">
    ...
    <div class="col-sm-5">
        <input name="title" value="<%if(fag==true){%><%=title%> <%}%>" type="text" class="form-control" placeholder="Tiêu đề SP không quá 70 kí tự" onchange="featuredcategory.countCharacters()" onkeypress="featuredcategory.countCharacters()" onkeydown="featuredcategory.countCharacters()" maxlength="125">
        <span class="pull-left mgt-15">Tối đa 70 ký tự - <span class="clr-org"><strong>Còn <span class="countresult">0/70</span></strong></span> ký tự</span>
