<div class="box box-red mobile-hidden">
    <div class="box-title">
    ...
    <div class="box-content">
        <div class="box-product bp-template2">
            <div class="bp-banner2 home-item">
                <div class="hoi-view">
                    <a class="hoi-btn" href="javascript:void();" onclick="featuredcategory.addBanner(1,'<%=this.id%>', 2)">Thay Banner</a>
                </div>
            ...
            <div class="bp-brand2 home-item">
                <div class="hoi-view">
                    <a class="hoi-btn" href="javascript:void();" onclick="featuredcategory.addLogo('<%=this.id%>',7,2)">Thay Logo</a>
                </div>
                ...
                <%}} else { %>
                <div class="bb-item"><a href="javascript:void();"><img src="<%=staticUrl%>/market/images/data/logo1.png" alt="logo"></a></div>
                <div class="bb-item"><a href="javascript:void();"><img src="<%=staticUrl%>/market/images/data/logo2.png" alt="logo"></a></div>
                <div class="bb-item"><a href="javascript:void();"><img src="<%=staticUrl%>/market/images/data/logo3.png" alt="logo"></a></div>
                <div class="bb-item"><a href="javascript:void();"><img src="<%=staticUrl%>/market/images/data/logo4.png" alt="logo"></a></div>
                <div class="bb-item"><a href="javascript:void();"><img src="<%=staticUrl%>/market/images/data/logo1.png" alt="logo"></a></div>
                <div class="bb-item"><a href="javascript:void();"><img src="<%=staticUrl%>/market/images/data/logo2.png" alt="logo"></a></div>
                <div class="bb-item"><a href="javascript:void();"><img src="<%=staticUrl%>/market/images/data/logo3.png" alt="logo"></a></div>
                <%}%>
            ...
            <div class="home-item squarehome-item bp1">
                <div class="hoi-inner">
                    <span class="hoi-sale"><span>Sale</span>50%</span>
                    ...
                    <div class="hoi-view">
                        <a class="hoi-btn" href="javascript:void();" onclick="featuredcategory.addItem(1, '<%=this.id%>', 2)">Thay SP</a>
                    </div>
                </div>
            </div><!-- home-item -->
            <div class="home-item bp2">
                <div class="hoi-inner">
                    ...
                    <div class="hoi-view">
                        <a class="hoi-btn" href="javascript:void();" onclick="featuredcategory.addItem(2, '<%=this.id%>', 2)">Thay SP</a>
                    </div>
                </div>
            </div><!-- home-item -->
            <div class="home-item bp3">
                <div class="hoi-inner">
                    ...
                    <div class="hoi-view">
                        <a class="hoi-btn" href="javascript:void();" onclick="featuredcategory.addItem(3, '<%=this.id%>', 2)">Thay SP</a>
                    </div>
                </div>
            </div><!-- home-item -->
            <div class="home-item bp4">
                <div class="hoi-inner">
                    ...
                    <div class="hoi-view">
                        <a class="hoi-btn" href="javascript:void();" onclick="featuredcategory.addItem(4, '<%=this.id%>', 2)">Thay SP</a>
                    </div>
                </div>
            </div><!-- home-item -->
            <div class="home-item bp5">
                <div class="hoi-inner">
                    ...
                    <div class="hoi-view">
                        <a class="hoi-btn" href="javascript:void();" onclick="featuredcategory.addItem(5, '<%=this.id%>', 2)">Thay SP</a>
                    </div>
                </div>
            </div><!-- home-item -->
        </div><!-- box-product -->
