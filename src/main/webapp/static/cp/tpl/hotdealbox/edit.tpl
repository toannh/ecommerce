...
<div class="row" style="padding-bottom: 10px;">
    ...
    <% } %>
    <div class="frame" id="frameIMG" style="margin: 0 0.3em; width: 158px; height: 158px; float: left">
        <img id="photo" src="<%=data.images[0]%>" width="200" height="200">
    </div><br/>
    ...
    <form id="form-edit" class="form-horizontal" role="form">
        <div class="left">
            ...
            <div class="radio" id="upload1">
                <input type="file" style="display:none" id="lefile" name="images" onchange="hotdealbox.addImage();">
