...
<form id="image-form" class="form-horizontal" role="form">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-5">
            <input name="title" value="<%=(typeof data!=='undefined')? data.name: ''%>" onchange="landingnew.changeItemName(this);" for="<%=(typeof data!=='undefined')? data.id: ''%>" type="text" class="form-control landingNewName<%=(typeof data!=='undefined')? data.id: ''%>" placeholder="Tiêu đề sản phẩm">
        </div>
    </div>
</form>
