...
<form class="form-horizontal" id="form-add">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10"> 
            <select class="form-control" name="categoryId" onchange="news.loadCateSub($(this).val());">
                ...
                <option value="<%= newsCategories[i].id %>"><%= newsCategories[i].name %></option>
                <% } %>
                <% } %>
            </select>  
        </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input name="textSearch" value="<%= (typeof data!=='undefined')? data.textSearch: ''%>" type="text" class="form-control" placeholder="Từ khóa cho tìm kiếm"/>
        </div>
    </div>
