...
$('.regular_text_left, .regular_text_right, .list-items div, .center_phone, .feature-list, .features .title, .features a, .underline-p, .close-up .title, .landscape-phone, .gallery .title, .app_overview .title, #gallery-images, .newsletter .title, .work .title, .newsletter form, .footer .logo *').css('opacity','0.3');
...
// ************************ //
  ...
  $('.list-items div:eq(6)').one('inview', function (event, visible) {
    if (visible) {   $(this).addClass('animated fadeInUp delay1s');   }});
  $('.list-items div:eq(7)').one('inview', function (event, visible) {
    if (visible) {   $(this).addClass('animated fadeInUp delay1s');   }});
  $('.list-items div:eq(8)').one('inview', function (event, visible) {
    if (visible) {   $(this).addClass('animated fadeInUp delay1s');   }});
  $('.list-items div:eq(9)').one('inview', function (event, visible) {
    if (visible) {   $(this).addClass('animated fadeInUp delay1s');   }});
  $('.list-items div:eq(10)').one('inview', function (event, visible) {
    if (visible) {   $(this).addClass('animated fadeInUp delay1s');   }});
  $('.list-items div:eq(11)').one('inview', function (event, visible) {
    if (visible) {   $(this).addClass('animated fadeInUp delay1s');   }});
