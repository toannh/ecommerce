...
<div class="box-product bp-template1">
    ...
    <div class="bp-brand1">
        ...
        <div class="bb-item"><a href="javascript:;" rel="nofollow" onclick="urlUtils.manufacturerUrl('<%=this.categoryManufacturerHomes[i].manufacturerId%>');"><img src="<%=this.categoryManufacturerHomes[i].image%>" alt="logo"></a></div>
        <%}}%>
    </div>
    <div class="home-item bighome-item bp1">
        ...
        <div class="hoi-inner">
            ...
            <%}%>
            <a class="hoi-thumblink" target="_blank" rel="nofollow" href="<%= baseUrl %>/san-pham/<%= id1 %>/<%= textUtils.createAlias(name1) %>.html">
    ...
    <div class="home-item bighome-item bp2">
        ...
        <div class="hoi-inner">
            ...
            <%}%>
            <a class="hoi-thumblink" target="_blank" href="<%= baseUrl %>/san-pham/<%= id2 %>/<%= textUtils.createAlias(name2) %>.html">
    ...
    <div class="home-item bp6">
        ...
        <div class="hoi-inner">
            ...
            <%}%>
            <a class="hoi-thumblink" href="<%= baseUrl %>/san-pham/<%= id6 %>/<%= textUtils.createAlias(name6) %>.html" target="_blank">
                <img src="<%=image6%>" alt="product" />
            </a>

            <div class="hoi-title">
                <div class="hoi-row">
                    <a href="<%= baseUrl %>/san-pham/<%= id6 %>/<%= textUtils.createAlias(name6) %>.html" target="_blank"> <%=title6%></a>  
                </div>
                <div class="hoi-row">
    ...
    <div class="home-item bp7">
        ...
        <div class="hoi-inner">
            ...
            <%}%>
            <a class="hoi-thumblink" href="<%= baseUrl %>/san-pham/<%= id7 %>/<%= textUtils.createAlias(name7) %>.html" target="_blank">
                <img src="<%=image7%>" alt="product" />
            </a>

            <div class="hoi-title">
                <div class="hoi-row">
                    <a href="<%= baseUrl %>/san-pham/<%= id7 %>/<%= textUtils.createAlias(name7) %>.html" target="_blank"> <%=title7%></a>  
                </div>
                <div class="hoi-row">
    ...
    <div class="home-item bp8 zindex-bid">
        ...
        <div class="hoi-inner">
            ...
            <%}%>
            <a class="hoi-thumblink" href="<%= baseUrl %>/san-pham/<%= id8 %>/<%= textUtils.createAlias(name8) %>.html" target="_blank">
                <img src="<%=image8%>" alt="product" />
            </a>

            <div class="hoi-title">
                <div class="hoi-row">
                    <a href="<%= baseUrl %>/san-pham/<%= id8 %>/<%= textUtils.createAlias(name8) %>.html" target="_blank"> <%=title8%></a>  
                </div>
                <div class="hoi-row">
