<div class="grid">
    <div class="img">
        <a href="<%= baseUrl %>/san-pham/<%= data.id %>/<%= textUtils.createAlias(data.name) %>.html">
            <img src="<%=(typeof data.images != 'undefined' && data.images.length >0)?data.images[0]:staticUrl+'/market/images/no-image-product.png'%>" alt="<%=data.name%>">
        </a>
    </div>
    <div class="g-content">
