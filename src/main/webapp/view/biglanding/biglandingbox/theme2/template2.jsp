...
<div class="lb-box lb-box2">
                    	<div class="lb-category lb-category-right lb-bg-yellow">
                        	<div class="lbc-inner">
                            	<div class="lbc-title"><a href="${baseUrl}/biglanding/${landing.id}/${bigLandingCate.id}/${text:createAlias(bigLandingCate.name)}.html">${bigLandingCate.name}</a></div>
                                <div class="lbc-list">
                                	<ul>
                                ...
                                <div class="lbc-img"><img src="${bigLandingCate.image}" alt="img" /></div>
                                <a class="lbc-more" href="${baseUrl}/biglanding/${landing.id}/${bigLandingCate.id}/${text:createAlias(bigLandingCate.name)}.html">Xem tất cả</a>
                            </div><!-- /lbc-inner -->
                        </div><!-- /lb-category -->
                        <c:forEach items="${bigLandingCate.bigLandingItem}" var="blItem">
                            <c:if test="${blItem.position==2}">
                        <div class="lb-item lb-bigitem lb-position${blItem.position}">
                        </c:if>
                             <c:if test="${blItem.position !=2}">
                        <div class="lb-item lb-position${blItem.position}">
                        	...
                        	<div class="lbi-inner cdt-tooltip" data-toggle="tooltip" data-placement="top" title data-original-title="${blItem.promition}">
                            	<a href="${basicUrl}/san-pham/${blItem.itemId}/${text:createAlias(blItem.item.name)}.html"><img src="${blItem.image}" alt="img" /></a>
