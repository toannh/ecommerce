...
<ul class="nav nav-tabs" role="tablist">
    ...
    <li class="active"><a href="${baseUrl}/cp/addmodel.html">Danh sách model mới được tạo</a></li>
...
<div class="func-container" >
    <table class="table table-striped table-bordered table-responsive" style="margin-top: 10px">
        <tr>
            ...
            <th class="text-center" style="width: 450px; vertical-align: middle;" >
                <button onclick="addmodel.add();" type="button" class="btn btn-success">
        ...
        <c:forEach var="item" items="${data}">            
            <tr>
                ...
                <td class="text-left" style="vertical-align: middle">
                    ...
                    <div class="btn-group">
                        <button type="button" class="btn btn-primary" onclick="addmodel.editDetail('${item.id}');" >
                            <span class="glyphicon glyphicon-edit"></span> Chi tiết</button>
                        <button type="button" class="btn btn-warning" onclick="addmodel.showImages('${item.id}');" >
                            <span class="glyphicon glyphicon-list"></span> Hình ảnh</button>
                        <button type="button" class="btn btn-info"  onclick="addmodel.editProperties('${item.id}');"  >
                            <span class="glyphicon glyphicon-random"></span> Thuộc tính</button>
                        <button type="button" class="btn btn-success" onclick="addmodel.successAdd('${item.id}');" >
                            <span class="glyphicon glyphicon-remove"></span> Đã thêm xong</button>
                    </div>
                </td>
            </tr>
        </c:forEach>
