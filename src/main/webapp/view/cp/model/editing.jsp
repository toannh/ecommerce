...
<ul class="nav nav-tabs" role="tablist">
    ...
    <li class="active"><a href="${baseUrl}/cp/editmodel.html">Danh sách model yêu cầu sửa</a></li>
        ...
        <c:forEach var="item" items="${data}">            
            <tr>
                ...
                <td class="text-left" style="vertical-align: middle">
                    <div class="btn-group">
                        <button type="button" class="btn btn-primary" onclick="editmodel.editDetail('${item.id}');" >
                            <span class="glyphicon glyphicon-edit"></span> Chi tiết</button>
                        <button type="button" class="btn btn-warning" onclick="editmodel.showImages('${item.id}');" >
                            <span class="glyphicon glyphicon-list"></span> Hình ảnh</button>
                        <button type="button" class="btn btn-info"  onclick="editmodel.editProperties('${item.id}');"  >
                            <span class="glyphicon glyphicon-random"></span> Thuộc tính</button>
                        <button type="button" class="btn btn-success" onclick="editmodel.successEdit('${item.id}');" >
                            <span class="glyphicon glyphicon-remove"></span> Báo sửa xong</button>
                    </div>
                </td>
            </tr>
        </c:forEach>
