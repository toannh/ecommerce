                ...
                <div class="bp-banner1">
                    <c:forEach items="${categorySubItem.categoryBannerHomes}" var="banner">
                        <c:if test="${banner.position==1}">
                            <a href="${banner.url}" target="_blank"><img data-original="${banner.image}" class="lazy" alt="banner"></a>
                            </c:if>
                        </c:forEach>
                </div>
                <div class="bp-brand1">
                                ...
                                <div class="home-item bighome-item bp1">
                                    <div class="hoi-inner">
                                        ...
                                        <c:if test="${item.listingType == 'BUYNOW' && (text:percentPrice(item.startPrice,item.sellPrice,item.discount,item.discountPrice,item.discountPercent))>0}">
                                            ...
                                            <a class="hoi-thumblink" href="${basicUrl}/san-pham/${item.id}/${text:createAlias(item.name)}.html" target="_blank" target="_blank"><img data-original="${categoryItemHome.image}" class="lazy"
                                                                                                                                                     ></a>
                                        <div class="hoi-title">
