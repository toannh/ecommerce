...
<html>
    <head>
        ...
        <meta name="google-site-verification" content="-Ec9lYFOOBtRuc9k1Xb1-wPRI2dCPI1TweZxLpPgpUY" />
        <link rel="canonical" href="http://chodientu.vn${canonical}" />
        <c:if test="${refresh !=null && refresh !=''}">
        ...
        <meta name="google-site-verification" content="KeKdNish3piALlEBhlj7y2lJtpdTU0NOrVZ3Cj2Hke8" />
    </head>
    <body>
        <div id="fb-root"></div>
        ...
        <c:if test="${facebookTrack !=null && facebookTrack !=''}">
            <script>(function() {
...
window._fbq.push(['track', '6027572483175', {'value':'${facebookTrack}','currency':'VND'}]);
</script>
<noscript><img height="1" width="1" alt="" style="display:none" src="https://www.facebook.com/tr?ev=6027572483175&amp;cd[value]=${facebookTrack}&amp;cd[currency]=VND&amp;noscript=1" /></noscript>
        </c:if>
        <script>(function () {
                var _fbq = window._fbq || (window._fbq = []);
                if (!_fbq.loaded) {
