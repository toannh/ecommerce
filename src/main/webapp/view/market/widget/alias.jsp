            ...
            <c:forEach var="item" items="${alias}" varStatus="sttItem">
                <li>
                    ...
                    <div class="menu-expand">
                        ...
                        <div class="me3">
                            <div class="me3-banner"><a href="${item.bannerUrl}" title="${item.title}" target="_blank" rel="nofollow"><img src="${item.image}" alt="${item.title}" /></a></div>
                            <div class="me3-smallbanner">
                                <div class="ms-item"><a href="${item.bannerUrl1}" title="${item.title}" target="_blank" rel="nofollow"><img src="${item.image1}" alt="${item.title}" /></a></div>
                                <div class="ms-item"><a href="${item.bannerUrl2}" title="${item.title}" target="_blank" rel="nofollow"><img src="${item.image2}" alt="${item.title}" /></a></div>
                                <div class="ms-item"><a href="${item.bannerUrl3}" title="${item.title}" target="_blank" rel="nofollow"><img src="${item.image3}" alt="${item.title}" /></a></div>
                            </div>
                        </div><!-- /me3 -->
                    </div><!--menu-expand-->
                </li>
