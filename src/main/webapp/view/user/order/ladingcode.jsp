                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <c:if test="${order.paymentMethod != 'NONE' && order.paymentMethod != 'COD' && order.paymentStatus=='NEW' && weight<=2000}">     
                                    <div class="cdt-message-note" style="color: red;font-weight: bold; border: 1px dashed rgb(158, 97, 97);padding: 4px 10px; margin-top: 3px">
                                        Cảnh báo: Người mua chưa thanh toán, Bạn nên tính lại tiền thu hộ hợp lý
                                    </div>
                                </c:if>   
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <p class="clr-org"><strong>Lưu ý:</strong></p>
                                <p>Phí vận chuyển chỉ là tạm tính, dựa trên khai báo cân nặng phía trên. Trọng lượng thực tế của sản phẩm được xác định lại khi hãng vận chuyển tới lấy hàng và phí vận chuyển thực tế sẽ được cập nhật lại trên vận đơn tại tài khoản ShipChung. Người bán có thể kiểm tra lại bằng cách đăng nhập vào ShipChung.vn</p>
                        ...
                        <div class="mgt-25" style="text-align:center;">
                            ...
                            <a href="${baseUrl}/user/hoa-don-ban-hang.html" class="btn-remove">
