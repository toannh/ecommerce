            ...
            <div class="row config-shop-layout">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="${baseUrl}/user/shop-banner.html">Heart banner trang chủ</a></li>
                        <li><a href="${baseUrl}/user/shop-banner-ads.html">Banner quảng cáo</a></li>
                    </ul>                                        
                    <!-- Tab panes -->
                                ...
                                <c:if test="${shopBannerRow==null}">
                                    <div class="box-step mgt-25"> 
                                        ...
                                        <form class="form-horizontal" id="form-add-banner" role="form" >
                                            <input type="hidden" class="form-control" name="type" value="HEART">
                                                    ...
                                                    <div class="content-expand" id="box-type-flash-tab1" style="display: none">  
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <div class="clearfix">
                                                                    ...
                                                                    Dung lượng file up tối đa < 0.5MB, các định dạng file hợp lệ gif, jpg, jpeg
                                                                    <br/> Kích thước chuẩn: <span style="color: red">934x400px</span>
                                                                </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-6">
                                                                ...
                                                                <div class="help-block">Đường dẫn đích đến không được để thông tin ở ô này</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="table-responsive manager-content">
                                            <table class="table" width="100%">
                                                <tr class="warning">
                                                    ...
                                                    <th width="2%"> STT</th>
                                                    <th width="25%"> Ảnh</th>
                                                    <th width="33%" valign="middle"><div class="text-left">Đường dẫn/Tên mô tả</div></th>
                                                ...
                                                <c:forEach items="${shopBanners}" var="shopBanner">
                                                    <tr>
                                                        <td><input type="text" name="position" style="width: 40px" value="${shopBanner.position}" class="form-control"/></td>
                                                        <td>
                                                        ...
                                                        <td valign="top" align="center">
                                                            <div class="text-center">
                                                                ...
                                                                <a href="${baseUrl}/user/shop-banner.html?id=${shopBanner.id}"><button class="btn btn-info btn-sm">Sửa</button></a>
